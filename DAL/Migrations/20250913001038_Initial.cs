        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LetterNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CorrespondenceType = table.Column<int>(type: "int", nullable: false),
                    LetterRelationType = table.Column<int>(type: "int", nullable: false),
                    RelatedLetterId = table.Column<int>(type: "int", nullable: true),
                    ...
                    CopyReceivers = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Keywords = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    KeywordsList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SignerName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    SignerUserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    OrganizationArchiveDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Letters_Letters_RelatedLetterId",
                        column: x => x.RelatedLetterId,
            ...
            migrationBuilder.CreateTable(
                name: "LetterReferrals",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LetterId = table.Column<int>(type: "int", nullable: false),
                    ReferredToUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LetterReferrals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LetterReferrals_Letters_LetterId",
                        column: x => x.LetterId,
                        principalTable: "Letters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Organizations_Letters_LetterId",
                        column: x => x.LetterId,
                        principalTable: "Letters",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ostan = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    NameEdareh = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Emza = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Avatar = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: true),
                    HaqEmza = table.Column<bool>(type: "bit", nullable: false),
                    OrganizationId = table.Column<int>(type: "int", nullable: true),
                    UserName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    NormalizedUserName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CalendarActivity_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CalendarEventCategories_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowBusinessHours = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    NotificationAdvanceMinutes = table.Column<int>(type: "int", nullable: false),
                    Language = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CalendarType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnableDragAndDrop = table.Column<bool>(type: "bit", nullable: false),
                    EnableResize = table.Column<bool>(type: "bit", nullable: false),
                    ShowEventDetailsOnClick = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CodeKelaseh = table.Column<int>(type: "int", nullable: false),
                    NameKelaseh = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Kelasehnamehha", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LetterActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LetterActions_Letters_LetterId",
                        column: x => x.LetterId,
                        principalTable: "Letters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LetterActions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LetterApprovals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LetterApprovals_Letters_LetterId",
                        column: x => x.LetterId,
                        principalTable: "Letters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LetterApprovals_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LetterApprovals_Users_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LetterApprovals_Users_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_Users_ApplicationUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    IsManagerAnnouncement = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CalendarEvents_CalendarEventCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "CalendarEventCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketComments_Users_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CalendarEventParticipants_Users_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CalendarReminders_Users_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CalendarReminders_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalendarEventCategories_CreatedByUserId",
                table: "CalendarEventCategories",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CalendarEventParticipants_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalendarReminders_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LetterActions_LetterId",
                table: "LetterActions",
                column: "LetterId");

            migrationBuilder.CreateIndex(
                name: "IX_LetterActions_UserId",
                table: "LetterActions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LetterApprovals_ApproverId",
                table: "LetterApprovals",
                column: "ApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_LetterApprovals_LetterId",
                table: "LetterApprovals",
                column: "LetterId");

            migrationBuilder.CreateIndex(
                name: "IX_LetterApprovals_OrganizationId",
                table: "LetterApprovals",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_LetterApprovals_RequesterId",
                table: "LetterApprovals",
                column: "RequesterId");

            migrationBuilder.CreateIndex(
                name: "IX_LetterReferrals_LetterId",
                table: "LetterReferrals",
                column: "LetterId");

            migrationBuilder.CreateIndex(
                name: "IX_Letters_RelatedLetterId",
                table: "Letters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_LetterId",
                table: "Organizations",
                column: "LetterId");
