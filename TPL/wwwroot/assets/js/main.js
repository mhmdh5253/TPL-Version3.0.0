...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      // Init typeahead on searchInput (disabled for now)
      searchInput.each(function () {
        var $this = $(this);
        // Typeahead disabled - plugin not loaded
        /*
        searchInput
          .typeahead(
            {
          ...
          // Typeahead event handlers disabled
          /*
      ...
      searchInput.on('keyup', function () {
        if (psSearch && typeof psSearch.update === 'function') {
          psSearch.update();
        }
      });
    }
