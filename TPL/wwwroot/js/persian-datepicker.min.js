...
return (self["webpackChunktpl"] = self["webpackChunktpl"] || []).push([[486],{
...
!function (e, t) {
  ...
  return function (e) {
    ...
    !function (t, i) {
      ...
      var _n = function n(e) {
        return new _n.Instance(e);
      };
      _n.SUPPORT = "wheel", _n.ADD_EVENT = "addEventListener", _n.REMOVE_EVENT = "removeEventListener", _n.PREFIX = "", _n.READY = !1, _n.Instance = function (e) {
        return _n.READY || (_n.normalise.browser(), _n.READY = !0), this.element = e, this.handlers = [], this;
      }, _n.Instance.prototype = {
        wheel: function wheel(e, t) {
          return _n.event.add(this, _n.SUPPORT, e, t), "DOMMouseScroll" === _n.SUPPORT && _n.event.add(this, "MozMousePixelScroll", e, t), this;
        },
        unwheel: function unwheel(e, t) {
          return void 0 === e && (e = this.handlers.slice(-1)[0]) && (e = e.original), _n.event.remove(this, _n.SUPPORT, e, t), "DOMMouseScroll" === _n.SUPPORT && _n.event.remove(this, "MozMousePixelScroll", e, t), this;
        }
      }, _n.event = {
        add: function add(e, i, a, o) {
          ...
          a = function a(e) {
            e || (e = t.event);
            var i = _n.normalise.event(e),
              a = _n.normalise.delta(e);
            return s(i, a[0], a[1], a[2]);
          }, e.element[_n.ADD_EVENT](_n.PREFIX + i, a, o || !1), e.handlers.push({
            original: s,
            normalised: a
          });
        },
        remove: function remove(e, t, i, a) {
          ...
          o = r[s], i = o.normalised, e.element[_n.REMOVE_EVENT](_n.PREFIX + t, i, a || !1);
      ...
      _n.normalise = {
        browser: function browser() {
          "onwheel" in i || i.documentMode >= 9 || (_n.SUPPORT = void 0 !== i.onmousewheel ? "mousewheel" : "DOMMouseScroll"), t.addEventListener || (_n.ADD_EVENT = "attachEvent", _n.REMOVE_EVENT = "detachEvent", _n.PREFIX = "on");
        },
    ...
    !function (i, s) {
      ...
      h.prototype.eos = function () {
        ...
        var s = this,
          ...
          l = i.lookup(e[1]);
        if (l) {
          if (f(l)) for (var d = 0, c = l.length; d < c; ++d) r += this.renderTokens(e[4], i.push(l[d]), n, a);else if ("object" == _typeof(l) || "string" == typeof l || "number" == typeof l) r += this.renderTokens(e[4], i.push(l), n, a);else if (t(l)) {
